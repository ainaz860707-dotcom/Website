...
summary: "内容质量/EEAT评分"
description: 'Use when auditing content quality, E-E-A-T, or publish readiness; runs a typed 80-item CORE-EEAT profile with evidence coverage, veto checks, and a fix plan. Not for structural tags/headers alone — use on-page-seo-checker; not for domain/citation trust — use domain-authority-auditor. 内容质量/EEAT评分 Русские триггеры: оцени качество текста, E-E-A-T, готов ли текст к публикации, что не так с текстом, экспертность и доверие.'
version: "19.2.0"
license: Apache-2.0
...
class: auditor
metadata: {"author": "aaron-he-zhu", "version": "19.2.0", "discipline": "seo-geo", "phase": "tune", "geo-relevance": "high", "hermes": {"tags": ["marketing", "seo-geo", "tune"], "category": "seo-geo"}, "openclaw": {"emoji": "🔍", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}
---
...
- `../../seo-geo-shared/references/auditor-runbook.md`
- `../../seo-geo-shared/references/scoring-semantics.md`
- `../../seo-geo-shared/references/core-eeat-benchmark.md`
- `../../seo-geo-shared/references/framework-catalog.json`
- `../../seo-geo-shared/references/runtime-invocation.md`
...
1. `../../seo-geo-shared/references/auditor-runbook.md`
2. `../../seo-geo-shared/references/scoring-semantics.md`
3. `../../seo-geo-shared/references/core-eeat-benchmark.md`
4. `../../seo-geo-shared/references/framework-catalog.json` (`CORE-EEAT` entry)

For a standalone installation, read the bundled immutable `references/auditor-runtime.md` instead. Never fetch a mutable branch or continue with a guessed contract. Before deterministic calls, follow [`runtime-invocation.md`](../../seo-geo-shared/references/runtime-invocation.md), resolve `AARON_SKILLS_ROOT="${CLAUDE_PLUGIN_ROOT:-$(git rev-parse --show-toplevel 2>/dev/null || true)}"`, and require the scorer, validator, and typed catalogs. If they are absent, return `score_state: NOT_SCORED` / `score_confidence: not_scored` with no gate verdict or persistent artifact. Record `schema_version: 3.0`, `runbook_version: 3.0.0`, and catalog version in the report.
...
- [CORE-EEAT benchmark](../../seo-geo-shared/references/core-eeat-benchmark.md)
- [Auditor runbook](../../seo-geo-shared/references/auditor-runbook.md)
- [Scoring semantics](../../seo-geo-shared/references/scoring-semantics.md)
- [Item reference](references/item-reference.md)
- [Recursive refinement](references/recursive-refinement.md)
- [Humanizer controls](../../seo-geo-shared/references/humanizer-slop.md)
...
- **Resolve claims:** [offer-claims-registry](../../seo-geo-shared/protocol/offer-claims-registry/SKILL.md)
