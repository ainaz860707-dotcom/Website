...
summary: "SERP分析/搜索结果"
description: 'Use when the user asks to "analyze the SERP" or "SERP分析"; maps SERP features, layout, ranking factors, search intent, AI Overviews, and snippet opportunities for a query. Not for keyword demand discovery — use keyword-research. SERP分析/搜索结果 Русские триггеры: разбери выдачу, что в топе поиска, анализ SERP, блоки выдачи, featured snippet, People Also Ask, интент запроса.'
version: "19.2.0"
license: Apache-2.0
...
See [references/platforms/youtube.md](../../seo-geo-shared/references/platforms/youtube.md) for YouTube-as-citation detail.

## Save Results

Write path: `memory/research/serp-analysis/YYYY-MM-DD-<topic>.md`; promote durable difficulty/intent verdicts to `memory/hot-cache.md`. See [Skill Contract](../../seo-geo-shared/references/skill-contract.md) §Save Results Template.
...
- [YouTube as citation surface](../../seo-geo-shared/references/platforms/youtube.md) — Video SERP / outlier packaging and GEO/AI-citation notes
