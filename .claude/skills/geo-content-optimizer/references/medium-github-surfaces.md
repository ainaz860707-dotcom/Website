...
- `../../../seo-geo-shared/protocol/entity-registry/SKILL.md` — keep site ↔ Medium ↔ GitHub entity identity consistent
- `../../domain-authority-auditor/SKILL.md` — citation-trust gate (CITE)
