...
description: 'Use when the user asks to "optimize for AI citations"; improves citation readiness for ChatGPT, Perplexity, AI Overviews, Gemini, and Claude. Not for structural on-page SEO — use on-page-seo-checker; not for net-new drafting — use content-writer. AI引用优化/GEO优化/AI搜索 Русские триггеры: чтобы нейросети цитировали, оптимизация под ChatGPT / Perplexity / AI Overviews / Gemini, GEO-оптимизация, цитируемость, попасть в ответ ИИ.'
version: "19.2.0"
license: Apache-2.0
...
> **Project rule §12 — no invented facts about the client's business.** Never write a price, tenure, client count, award, name, testimonial, address, phone, hours, or guarantee that is not present in the user-supplied input. Missing input = placeholder, never a plausible invention. Never drop or substitute the city. Details: `second-brain/02_architecture/no-invented-facts.md`.
...
5. **CORE-EEAT GEO Self-Check** — verify C02, C04, C09, O02, O03, O05, O06, R01, R02, R04, R07, E01, Exp10, Ept08 with Pass/Warn/Fail. Then run the [slop self-check](../../seo-geo-shared/references/humanizer-slop.md) to strip AI-tell phrasing before the asset ships.
...
On user confirmation, save to `memory/content/YYYY-MM-DD-<topic>.md` — see [Skill Contract](../../seo-geo-shared/references/skill-contract.md) §Save Results Template.
...
- [Slop Self-Check](../../seo-geo-shared/references/humanizer-slop.md) - Pre-publish pass to strip AI-tell phrasing before content ships
- [Agent-Readable File Stack (llms.txt / OKF)](../../seo-geo-shared/references/llms-txt-okf.md) - Machine-readable files so agents and engines can parse your site
- [Grokipedia Tactics](../../seo-geo-shared/references/platforms/grokipedia.md) - AI-citation tactics for Grok / Grokipedia
- **GEO distribution surfaces** — platform refs engines pull from: [X](../../seo-geo-shared/references/platforms/x.md), [LinkedIn](../../seo-geo-shared/references/platforms/linkedin.md), [YouTube](../../seo-geo-shared/references/platforms/youtube.md), [Reddit](../../seo-geo-shared/references/platforms/reddit.md)
...
**Termination note**: keep a visited-set this session; if the recommended skill was already invoked, stop and report the chain complete rather than re-running it. Honor a max handoff depth of 3 to avoid loops (per [skill-contract.md §Termination rules](../../seo-geo-shared/references/skill-contract.md)).
