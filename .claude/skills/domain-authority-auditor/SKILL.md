...
summary: "域名权威/网站可信度"
description: 'Use when auditing domain authority, trust, or citation credibility; runs a peer-relative 40-item CITE profile with evidence coverage and verified manipulation/penalty veto checks. Not for page-level content quality — use content-quality-auditor; not for backlink profiling alone — use offsite-signal-analyzer. 域名权威/网站可信度 Русские триггеры: авторитет домена, доверие к сайту, насколько сайту доверяют поисковики, репутация домена.'
version: "19.2.0"
license: Apache-2.0
...
- `../../seo-geo-shared/references/cite-domain-rating.md`
...
- [CITE benchmark](../../seo-geo-shared/references/cite-domain-rating.md)
...
- **Repair entity state:** [entity-registry](../../seo-geo-shared/protocol/entity-registry/SKILL.md)
