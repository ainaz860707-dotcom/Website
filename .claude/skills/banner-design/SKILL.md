---
name: banner-design
description: "Design banners for social media, ads, website heroes, creative assets, and print. Multiple art direction options with AI-generated visuals. Actions: design, create, generate banner. Platforms: Facebook, Twitter/X, LinkedIn, YouTube, Instagram, Google Display, website hero, print. Styles: minimalist, gradient, bold typography, photo-based, illustrated, geometric, retro, glassmorphism, 3D, neon, duotone, editorial, collage. Uses ui-ux-pro-max, frontend-design, ai-artist, ai-multimodal skills. Русские триггеры: сделай баннер, креатив для рекламы, обложка для соцсетей, шапка канала, картинка для поста, баннер на первый экран сайта, макет для печати. Не для генерации секций лендинга — imagegen-frontend-web; не для бренд-досок — brandkit."
