...
npm run patch:2026-05-06-update-config
```
...
```json
{
  "scripts": {
    ...
    "seed:incremental": "npm prisma/seed-incremental.ts",
    "patch:2026-05-06-update-config": "npm scripts/patches/2026-05-06-update-config.ts"
  }
}
```
