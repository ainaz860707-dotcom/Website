---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web and mobile. Searchable local database with 84 styles, 192 color palettes, 74 font pairings, 192 product types, 98 UX guidelines, 104 icon entries, 16 GSAP motion presets, and 25 chart types across 22 stacks (React, Next.js, Vue, Nuxt, Svelte, Astro, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui, Jetpack Compose, Angular, Laravel, JavaFX, WPF, WinUI, Avalonia, Uno Platform, UWP, Three.js, and HTML/CSS). Use when designing, building, or reviewing UI: pages, components, color schemes, typography, layout, accessibility, animation, or data visualization. Русские триггеры: подбери палитру, какие цвета взять, подбери шрифты, шрифтовая пара, дизайн-система под проект, какой стиль подойдёт этому продукту, проверь интерфейс на UX, доступность и контраст, размеры кнопок и отступы, какой график выбрать для этих данных, правила интерфейса под React / Next.js / Vue / Tailwind / shadcn / Flutter / SwiftUI."
---
...
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "<query>" --domain <domain>
```
...
The database is English-only: a Russian `<query>` returns 0 results even when the entry exists. Translate the request before querying (`автосервис` → `car service`, `лендинг` → `landing page`, `магазин` → `e-commerce`) and report findings back in Russian.
...
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --stack <stack>
```
...
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "search loading animation" --domain ux

# Step 4: stack guidelines
python "/Users/ainazsadrtdinova/Desktop/Website/.claude/skills/ui-ux-pro-max/scripts/search.py" "suspense streaming bundle" --stack nextjs
```
