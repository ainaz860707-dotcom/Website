...
export const TECHNIQUES = [
  ...
  - медленное приближение кадра, 8–12s, масштаб от 1 до 1.06 — продукт «дышит»;
  ...
  offset-distance от 0% до 100%, длительность 6–14s, задержка своя, направление у части
  обратное; крылья трепещут циклом 0.12–0.2s; размер не больше 24px. Одинаковые траектории
