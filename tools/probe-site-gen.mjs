...
- Два блока на странице длиной 134–167 слов каждый: столько занимает кусок, который
  нейросеть забирает в ответ целиком. Ставь их в «услуги» и «как это устроено», не в FAQ —
  ответы в FAQ остаются короткими. Блок читается отдельно от страницы: тот, кто видит
  только его, понимает, о чём речь, без остального текста.
...
- Длина блока набирается объяснением того, что владелец уже сказал: как идёт работа, что
  входит, чем один вариант отличается от другого. Ни одного нового факта о бизнесе ради
  объёма — это тот же запрет, что выше, и он сильнее требования длины. Не набирается
  честно — пусть блок будет короче.
