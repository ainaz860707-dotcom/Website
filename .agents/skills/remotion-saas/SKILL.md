---
name: remotion-saas
description: "Build an app with Remotion Русские триггеры: редактор видео внутри приложения, рендер по кнопке из интерфейса, видео по данным пользователя, Remotion Lambda, рендер на сервере."
version: 4.0.509
---
