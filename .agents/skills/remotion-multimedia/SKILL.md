...
description: "Interacting with Mediabunny Русские триггеры: узнать длительность видео, метаданные медиафайла, разобрать видео в браузере, Mediabunny, кодек и разрешение файла."
version: 4.0.509
---
