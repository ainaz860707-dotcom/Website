...
description: "Structure Remotion markup for interactivity Русские триггеры: не редактируется в студии, сделай параметры ролика редактируемыми, правки текста прямо в превью, элемент не выделяется в Studio."
version: 4.0.509
---
