...
description: "Router for all Remotion skills Роутер по скиллам Remotion: бери его, когда неясно, какой именно нужен. Русские триггеры: сделай видео кодом, Remotion, ремоушн, программное видео, видео на React, ролик из вёрстки."
version: 4.0.509
---
